...
namespace SusiSu.Controllers
{
    public class SiparisController : Controller
    {
        ...
        [HttpPost]
        public  ActionResult _SiparisOlustur(Siparis siparis,SiparisDetay siparisDetay)
        {
            ...
            int sonsip = db.Siparis.OrderByDescending(x => x.ID).FirstOrDefault().ID;
            
            sd.Adet = siparisDetay.Adet;

            sd.SiparisID= sonsip;
            sd.SuID = 1;//ürün seçtirmediğim için bir yaptık şimdilik
            sd.Fiyat = 1;
        ...
        public ActionResult SiparisOlustur(int boy)
        {
            ViewBag.EnumValue=Enum.GetName(typeof(Enums.Enums.Boy), boy);
            //var typeList = new List<Enums.Enums.Boy>();
            //Enums.Enums.Boy.GetName(boy);
            //var typeList = Enum.GetValues(typeof(Enums.Enums.Boy))
            //   .Cast<Enums.Enums.Boy>()
            //   .Select(t => new SelectListItem
            //   {
            //       Id = ((int)t),
            //       Name = t.ToString()
            //   });
            //Enum.GetValues(typeof(Enums.Enums.Boy)).Cast<Enums.Enums.Boy>.Select(g => new SelectListItem
            //{
            //    Text = g.ToString(),
            //    Value = ((int)g).ToString()
            //}).ToList();
            //ViewBag.Tur = db.Su.Include(x => x.Boy == boy);
            return View();
        }
